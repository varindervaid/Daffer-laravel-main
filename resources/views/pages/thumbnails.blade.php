											...
											<div class="example">
												<div class="row row-sm">
													<div class="col-6 col-md-3">
														<img alt="Responsive image" class="img-thumbnail" src="{{asset('assets/img/media/9.jpg')}}">
													</div>
													<div class="col-6 col-md-3">
														<img alt="Responsive image" class="img-thumbnail" src="{{asset('assets/img/media/13.jpg')}}">
													</div>
													<div class="col-6 col-md-3 mg-t-10 mg-sm-t-0">
														<img alt="Responsive image" class="img-thumbnail" src="{{asset('assets/img/media/14.jpg')}}">
													</div>
													<div class="col-6 col-md-3 mg-t-10 mg-sm-t-0">
														<img alt="Responsive image" class="img-thumbnail" src="{{asset('assets/img/media/15.jpg')}}">
													</div>
												</div>
											</div>
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="images2"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="row row-sm">
	<div class="col-6 col-md-3">
		<img alt="Responsive image" class="img-thumbnail" src="{{asset('assets/img/media/9.jpg')}}">
	</div>
	<div class="col-6 col-md-3">
							...
							<div class="card custom-card" id="aligning">
								<div class="card-body">
									...
									<div class="text-wrap">
										<div class="example">
											<div class="clearfix">
											  <img src="{{asset('assets/img/media/10.jpg')}}" class="float-sm-left wd-100p wd-sm-200" alt="img">
											  <img src="{{asset('assets/img/media/11.jpg')}}" class="float-sm-right wd-100p wd-sm-200 mg-t-10 mg-sm-t-0" alt="img">
											</div>
										</div>
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="images3"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="clearfix">
  <img src="{{asset('assets/img/media/10.jpg')}}" class="float-sm-left wd-100p wd-sm-200" alt="img">
  <img src="{{asset('assets/img/media/11.jpg')}}" class="float-sm-right wd-100p wd-sm-200 mg-t-10 mg-sm-t-0" alt="img">
</div></script></code></pre>
										...
										<div class="example">
											<div class="row row-sm">
												<div class="col-sm-6">
													<div class="img-thumbnail">
														<a href="javascript:void(0);">
															<img src="{{asset('assets/img/media/9.jpg')}}" alt="thumb1" class="thumbimg">
														</a>
														<div class="caption">
															<h5>Thumbnail label</h5>
															<p>sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
															<div class="btn btn-list">
																<a href="javascript:void(0);" class="btn ripple btn-primary" role="button">Button</a>
																<a href="javascript:void(0);" class="btn ripple btn-secondary" role="button">Button</a>
															</div>
														</div>
													</div>
												</div>
												<div class="col-sm-6">
													<div class="img-thumbnail">
														<a href="javascript:void(0);">
															<img src="{{asset('assets/img/media/8.jpg')}}" alt="thumb1" class="thumbimg">
														</a>
														<div class="caption">
															<h5>Thumbnail label</h5>
															<p>sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="images5"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="row row-sm">
								...
								<div class="col-lg-6 col-md-6 col-12">
									<div class="card custom-card" id="responsive">
										<div class="card-body ht-100p ">
											...
											<div class="text-wrap">
												<div class="example">
													<div><img alt="Responsive image" class="img-fluid" src="{{asset('assets/img/media/7.jpg')}}"></div>
												</div>
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="images1"><pre><code class="language-markup"><script type="htms-Spruha/script"><div><img alt="Responsive image" class="img-fluid" src="{{asset('assets/img/media/7.jpg')}}"></div>
</script></code></pre>
											...
											<div class="text-wrap">
												<div class="example">
													<figure class="pos-relative mg-b-0">
														<img alt="Responsive image" class="img-fit-cover" src="{{asset('assets/img/media/12.jpg')}}">
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="images4"><pre><code class="language-markup"><script type="htms-Spruha/script"><figure class="pos-relative mg-b-0">
	<img alt="Responsive image" class="img-fit-cover" src="{{asset('assets/img/media/12.jpg')}}">
	<figcaption class="pos-absolute a-0 pd-25 bg-black-5 tx-white-8">
		<h6 class="tx-14 tx-sm-16 tx-white tx-semibold mg-b-15 mg-sm-b-20">What Does Royalty-Free Mean?</h6>
		<p class="mg-b-0">Royalty free means you just need to pay for rights to use the item once per end product. You don't need to pay additional or ongoing fees for each person who sees or uses it.</p>
...
<!-- End Prism Precode -->
							...
							<div class="col-xxl-3 col-xl-4 col-lg-12  d-none d-xl-block custom-leftnav">
