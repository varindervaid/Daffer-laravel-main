									...
									<div class="card-body">
										<ul class="visitor mb-0 d-block users-images list-unstyled list-unstyled-border">
											<li class="media d-flex mb-3 mt-0 pt-0">
												<img class="me-3 rounded-circle avatar avatar-md" src="{{asset('assets/img/users/3.jpg')}}" alt="avatar">
											...
											<li class="media d-flex mb-3">
												<img class="me-3 rounded-circle avatar avatar-md" src="{{asset('assets/img/users/5.jpg')}}" alt="avatar">
												<div class="media-body mb-1">
											...
											<li class="media d-flex mb-3">
												<img class="me-3 rounded-circle avatar avatar-md" src="{{asset('assets/img/users/7.jpg')}}" alt="avatar">
												<div class="media-body mb-1">
											...
											<li class="media d-flex mb-3">
												<img class="me-3 rounded-circle avatar avatar-md" src="{{asset('assets/img/users/4.jpg')}}" alt="avatar">
												<div class="media-body mb-1">
											...
											<li class="media d-flex mb-0">
												<img class="me-3 rounded-circle avatar avatar-md" src="{{asset('assets/img/users/9.jpg')}}" alt="avatar">
												<div class="media-body mb-1">
													<div class="float-end"><small>19-9-2018</small></div>
													<h5 class="media-title tx-15 mb-0">Anthony</h5>
													<small class="text-muted">sed do eiusmod </small>
								...
								<div class="card custom-card">
									...
									<div class="product-timeline card-body pt-3 mt-1">
										<ul class="timeline-1 mb-0">
											<li class="mt-0"> <i class="ti-pie-chart product-icon"></i> <span class="font-weight-semibold mb-4 tx-14 ">Total Products</span> <a href="javascript:void(0);" class="float-end tx-11 text-muted">3 days ago</a>
												<p class="mb-0 text-muted tx-12">1.3k New Products</p>
											</li>
											<li class="mt-0"> <i class="mdi mdi-cart-outline product-icon"></i> <span class="font-weight-semibold mb-4 tx-14 ">Total Sales</span> <a href="javascript:void(0);" class="float-end tx-11 text-muted">35 mins ago</a>
												<p class="mb-0 text-muted tx-12">1k New Sales</p>
											</li>
											<li class="mt-0"> <i class="ti-bar-chart-alt product-icon"></i> <span class="font-weight-semibold mb-4 tx-14 ">Toatal Revenue</span> <a href="javascript:void(0);" class="float-end tx-11 text-muted">50 mins ago</a>
												<p class="mb-0 text-muted tx-12">23.5K New Revenue</p>
											</li>
											<li class="mt-0"> <i class="ti-wallet product-icon"></i> <span class="font-weight-semibold mb-4 tx-14 ">Toatal Profit</span> <a href="javascript:void(0);" class="float-end tx-11 text-muted">1 hour ago</a>
												<p class="mb-0 text-muted tx-12">3k New profit</p>
											</li>
											<li class="mt-0 mb-0"><i class="si si-eye product-icon"></i> <span class="font-weight-semibold mb-4 tx-14 ">Customer Visits</span> <a href="javascript:void(0);" class="float-end tx-11 text-muted">1 day ago</a>
									...
									<div class="card-body pt-0">
										<ul class="top-selling-products pb-0 mb-0 px-0">
											<li class="product-item">
												<div class="product-img"><img src="{{asset('assets/img/pngs/14.png')}}" alt=""></div>
											...
											<li class="product-item">
												<div class="product-img"><img src="{{asset('assets/img/pngs/18.png')}}" alt=""></div>
												<div class="product-info">
											...
											<li class="product-item">
												<div class="product-img"><img src="{{asset('assets/img/pngs/17.png')}}" alt=""></div>
												<div class="product-info">
											...
											<li class="product-item">
												<div class="product-img"><img src="{{asset('assets/img/pngs/16.png')}}" alt=""></div>
												<div class="product-info">
											...
											<li class="product-item pb-0">
												<div class="product-img"><img src="{{asset('assets/img/pngs/19.png')}}" alt=""></div>
												<div class="product-info">
								...
								<div class="card custom-card overflow-hidden">
									<div class="card-header border-bottom-0 d-flex">
										...
										<div class="card-options float-end">
											<a href="javascript:void(0);" class="me-0 text-default" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"> <span class="fe fe-more-vertical tx-17 float-end"></span> </a>
										...
										<div class="table-responsive">
											<table class="table table-vcenter border mb-0 text-nowrap table-product">
												...
												<tbody>
													<tr>
														<td>#C234</td>
														<td class="d-flex my-auto"><img src="{{asset('assets/img/pngs/14.png')}}" alt="" class="ht-40 wd-40 me-3"><span class="my-auto">Regular waterproof (24 L) Backpack</span></td>
														<td><b>$14,500</b></td>
														<td>2,977</td>
													...
													<tr>
														<td>#C389</td>
														<td class="d-flex my-auto"><img src="{{asset('assets/img/pngs/15.png')}}" alt="" class="ht-40 wd-40 me-3"><span class="my-auto">Women Pink Heels Sandal</span></td>
														<td><b>$30,000</b></td>
														<td>678</td>
													...
													<tr>
														<td>#C936</td>
														<td class="d-flex my-auto"><img src="{{asset('assets/img/pngs/16.png')}}" alt="" class="ht-40 wd-40 me-3"><span class="my-auto">Designer Decorative flower Pot</span></td>
														<td><b>$13,200</b></td>
														<td>4,922</td>
													...
													<tr>
														<td>#C493</td>
														<td class="d-flex my-auto"><img src="{{asset('assets/img/pngs/17.png')}}" alt="" class="ht-40 wd-40 me-3"><span class="my-auto">Plastic Outdoor Chair</span></td>
														<td><b>$15,100</b></td>
														<td>1,234</td>
														<td><span class="badge bg-primary">Limited</span></td>
													</tr>
													<tr>
														<td>#C729</td>
														<td class="d-flex my-auto"><img src="{{asset('assets/img/pngs/18.png')}}" alt="" class="ht-40 wd-40 me-3"><span class="my-auto">Blck Digital smart watch</span></td>
														<td><b>$5,987</b></td>
														<td>4,789</td>
													...
													<tr>
														<td>#C529</td>
														<td class="d-flex my-auto"><img src="{{asset('assets/img/pngs/19.png')}}" alt="" class="ht-40 wd-40 me-3"><span class="my-auto">Apple iPhone(Black, 128 GB)</span></td>
														<td><b>$11,987</b></td>
														<td>938</td>
														<td><span class="badge bg-primary">Limited</span></td>
													</tr>
									...
									<div class="card-body pt-1">
										<div class="border">
											<div class="list-group projects-list pt-0 pb-0 ps-0 pe-0">
												...
												<a href="javascript:void(0);" class="list-group-item list-group-item-action flex-column align-items-start border-start-0 border-end-0 border-top">
													<div class="d-flex w-100 justify-content-between">
