										...
										<div class="text-wrap">
											<div class="example">
												<div class="media d-block d-sm-flex">
													<img alt="img" class="wd-100p wd-sm-200  mg-sm-r-20 mg-b-20 mg-sm-b-0" src="{{asset('assets/img/media/1.jpg')}}">
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="media1"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="media d-block d-sm-flex">
	<img alt="img" class="wd-100p wd-sm-200  mg-sm-r-20 mg-b-20 mg-sm-b-0" src="{{asset('assets/img/media/1.jpg')}}">
	<div class="media-body">
								...
								<div class="card custom-card" id="nesting">
									<div class="card-body">
										...
										<div class="text-wrap">
											<div class="example">
												<div class="media d-block d-sm-flex">
													<img alt="img" class="wd-100p wd-sm-100  mg-sm-r-20 mg-b-20 mg-sm-b-0" src="{{asset('assets/img/media/2.jpg')}}">
													<div class="media-body">
														<h5>Media heading</h5>
														<p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
														<div class="media d-block d-sm-flex mg-t-25">
															<img alt="img" class="wd-100p wd-sm-100  mg-sm-r-20 mg-b-20 mg-sm-b-0" src="{{asset('assets/img/media/3.jpg')}}">
															<div class="media-body">
																<h5>Media heading</h5>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
															</div>
														</div>
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="media2"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="media d-block d-sm-flex">
	<img alt="img" class="wd-100p wd-sm-100  mg-sm-r-20 mg-b-20 mg-sm-b-0" src="{{asset('assets/img/media/2.jpg')}}">
	<div class="media-body">
								...
								<div class="card custom-card" id="align">
									<div class="card-body">
										...
										<div class="text-wrap">
											<div class="example">
												<div class="media d-block d-sm-flex">
													<img alt="img" class="wd-100p wd-sm-100  mg-sm-r-20 mg-b-20 mg-sm-b-0 align-self-center" src="{{asset('assets/img/media/4.jpg')}}">
													<div class="media-body">
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="media3"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="media d-block d-sm-flex">
	<img alt="img" class="wd-100p wd-sm-100  mg-sm-r-20 mg-b-20 mg-sm-b-0 align-self-center" src="{{asset('assets/img/media/4.jpg')}}">
	<div class="media-body">
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="media5"><pre><code class="language-markup"><script type="htms-Spruha/script"><ul class="list-unstyled">
	<li class="media d-block d-sm-flex">
		<img alt="img" class="wd-100p wd-sm-100  mg-sm-r-20 mg-b-20 mg-sm-b-0" src="{{asset('assets/img/media/6.jpg')}}">
		<div class="media-body">
			<h5 class="tx-inverse">Media heading</h5>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
									...
									<div class="card-body">
										...
										<div class="text-wrap">
											<div class="example">
												...
												<div class="media-body">
													<h5>Media heading</h5>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
												</div><img alt="img" class="wd-100p wd-sm-200  mg-sm-l-20 mg-t-20 mg-sm-t-0" src="{{asset('assets/img/media/5.jpg')}}"></div>
											</div>
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="media4"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="media d-block d-sm-flex">
<div class="media-body">
	<h5 class="tx-inverse">Media heading</h5>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
</div><img alt="img" class="wd-100p wd-sm-200  mg-sm-l-20 mg-t-20 mg-sm-t-0" src="{{asset('assets/img/media/5.jpg')}}"></div></script></code></pre>
							...
							<div class="col-xl-3 col-lg-12 d-none d-xl-block custom-leftnav">
								<div class="main-content-left-components">
									...
									<div class="card custom-card">
										<div class="card-body user-card text-center">
											<div class="main-img-user avatar-lg online text-center">
												<img alt="avatar" class="-circle" src="{{asset('assets/img/users/5.jpg')}}">
											</div>
											<div class="mt-2">
									...
									<div class="card custom-card">
										<div class="card-body user-card text-center">
											<div class="main-img-user avatar-lg online text-center">
												<img alt="avatar" class="-circle" src="{{asset('assets/img/users/4.jpg')}}">
											</div>
											<div class="mt-2">
