...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="spinner7"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="spinner-border" role="status">
	<span class="sr-only">Loading...</span>
</div></script></code></pre>
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="spinner1"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="spinner-border text-primary" role="status">
	<span class="sr-only">Loading...</span>
</div>
<div class="spinner-border text-secondary" role="status">
	<span class="sr-only">Loading...</span>
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="spinner2"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="spinner-grow" role="status">
	<span class="sr-only">Loading...</span>
</div></script></code></pre>
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="spinner3"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="spinner-grow text-primary" role="status">
	<span class="sr-only">Loading...</span>
</div>
<div class="spinner-grow text-secondary" role="status">
	<span class="sr-only">Loading...</span>
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="spinner4"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="text-center mg-b-20">
	<div class="spinner-border" role="status">
		<span class="sr-only">Loading...</span>
	</div>
</div>
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="spinner5"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="spinner-border spinner-border-sm" role="status">
	<span class="sr-only">Loading...</span>
</div>
<div class="spinner-grow spinner-grow-sm" role="status">
	<span class="sr-only">Loading...</span>
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="spinner6"><pre><code class="language-markup"><script type="htms-Spruha/script"><button class="btn ripple btn-primary" type="button"><span aria-hidden="true" class="spinner-border spinner-border-sm" role="status"></span> <span class="sr-only">Loading...</span></button>
<button class="btn ripple btn-secondary" disabled type="button"><span aria-hidden="true" class="spinner-border spinner-border-sm" role="status"></span> Loading...</button>
</script></code></pre>
