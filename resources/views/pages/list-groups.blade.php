...
@section('content')
					...
					<div class="page-header">
						<div>
							<h2 class="main-content-title tx-24 mg-b-5">List Groups</h2>
							<ol class="breadcrumb">
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="listgroup1"><pre><code class="language-markup"><script type="htms-Spruha/script"><ul class="list-group">
	<li class="list-group-item">Cras justo odio</li>
	<li class="list-group-item">Dapibus ac facilisis in</li>
	<li class="list-group-item">Morbi leo risus</li>
	<li class="list-group-item">Porta ac consectetur ac</li>
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="listgroup2"><pre><code class="language-markup"><script type="htms-Spruha/script"><ul class="list-group">
	<li class="list-group-item">Cras justo odio</li>
	<li class="list-group-item active">Dapibus ac facilisis in</li>
	<li class="list-group-item">Morbi leo risus</li>
	<li class="list-group-item">Porta ac consectetur ac</li>
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="listgroup3"><pre><code class="language-markup"><script type="htms-Spruha/script"><ul class="list-group">
	<li class="list-group-item">Cras justo odio</li>
	<li class="list-group-item disabled">Dapibus ac facilisis in</li>
	<li class="list-group-item">Morbi leo risus</li>
	<li class="list-group-item">Porta ac consectetur ac</li>
											...
											<div class="example">
												<div class="">
													<div class="list-group">
														...
														<a class="list-group-item list-group-item-action" href="javascript:void(0);">Vestibulum at eros</a>
													</div>
												</div>
											</div>
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="listgroup4"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="list-group">
	<a class="list-group-item list-group-item-action active" href="javascript:void(0);">Cras justo odio</a>
	<a class="list-group-item list-group-item-action" href="javascript:void(0);">Dapibus ac facilisis in</a>
	<a class="list-group-item list-group-item-action" href="javascript:void(0);">Morbi leo risus</a>
	<a class="list-group-item list-group-item-action" href="javascript:void(0);">Porta ac consectetur ac</a>
												...
												<div class="">
													<ul class="list-group">
														<li class="list-group-item d-flex align-items-center">
															<img alt="avatar" class="wd-30 rounded-circle mg-r-15" src="{{asset('assets/img/users/2.jpg')}}">
															<div>
																<h6 class="tx-13 tx-inverse tx-semibold mg-b-0">Adrian Monino</h6><span class="d-block tx-11 text-muted">Premium Member</span>
															</div>
														</li>
														<li class="list-group-item d-flex align-items-center">
															<img alt="avatar" class="wd-30 rounded-circle mg-r-15" src="{{asset('assets/img/users/3.jpg')}}">
															<div>
																<h6 class="tx-13 tx-inverse tx-semibold mg-b-0">Joel Mendez</h6><span class="d-block tx-11 text-muted">Premium Member</span>
															</div>
														</li>
														<li class="list-group-item d-flex align-items-center">
															<img alt="avatar" class="wd-30 rounded-circle mg-r-15" src="{{asset('assets/img/users/4.jpg')}}">
															<div>
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="listgroup5"><pre><code class="language-markup"><script type="htms-Spruha/script"><ul class="list-group wd-md-50p">
	<li class="list-group-item d-flex align-items-center">
		<img alt="avatar" class="wd-30 rounded-circle mg-r-15" src="{{asset('assets/img/users/2.jpg')}}">
		<div>
			<h6 class="tx-13 tx-inverse tx-semibold mg-b-0">Adrian Monino</h6><span class="d-block tx-11 text-muted">Premium Member</span>
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="listgroup6"><pre><code class="language-markup"><script type="htms-Spruha/script"><ul class="list-group list-group-flush">
  <li class="list-group-item">Cras justo odio</li>
  <li class="list-group-item">Dapibus ac facilisis in</li>
  <li class="list-group-item">Morbi leo risus</li>
  <li class="list-group-item">Porta ac consectetur ac</li>
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="listgroup8"><pre><code class="language-markup"><script type="htms-Spruha/script"><ul class="list-group">
  <li class="list-group-item">Dapibus ac facilisis in</li>
  <li class="list-group-item list-group-item-primary">A simple primary list group item</li>
  <li class="list-group-item list-group-item-secondary">A simple secondary list group item</li>
  <li class="list-group-item list-group-item-success">A simple success list group item</li>
												...
												<div class="">
													<ul class="list-group">
													  ...
													  <li class="list-group-item d-flex justify-content-between align-items-center">
														...
														<span class="badge bg-primary bg-pill">2</span>
													  </li>
													  <li class="list-group-item d-flex justify-content-between align-items-center">
														Morbi leo risus
														<span class="badge bg-primary bg-pill">1</span>
													  </li>
													</ul>
												</div>
											</div>
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="listgroup9"><pre><code class="language-markup"><script type="htms-Spruha/script"><ul class="list-group">
  <li class="list-group-item d-flex justify-content-between align-items-center">
	Cras justo odio
	<span class="badge bg-primary bg-pill">14</span>
  </li>
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="listgroup10"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="list-group">
  <a href="javascript:void(0);" class="list-group-item list-group-item-action active">
	<div class="d-flex w-100 justify-content-between">
	  <h5 class="mb-1">List group item heading</h5>
	  <small>3 days ago</small>
...
<!---Prism Pre code-->
<figure class="highlight clip-widget" id="list40"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="listgroup-example2">
	<ul class="list-group">
		<li>Dapibus ac facilisis in</li>
		<li>Morbi leo risus</li>
		<li>Cras justo odio
													...
													<ul class="list-group">
														...
														<li>Cras justo odio
															<ul class="list-group checked">
															  <li class="list-group-item"><i class="fe fe-check me-3 tx-13" aria-hidden="true"></i>Lorem </li>
															  <li class="list-group-item"><i class="fe fe-check me-3 tx-13" aria-hidden="true"></i>established</li>
															  <li class="list-group-item"><i class="fe fe-check me-3 tx-13" aria-hidden="true"></i>Contrary</li>
															</ul>
														</li>
														<li>Porta ac consectetur ac</li>
														<li>Vestibulum at eros</li>
...
<!---Prism Pre code-->
<figure class="highlight clip-widget" id="list15"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="listgroup-example ">
	<ul class="list-group">
		<li>Dapibus ac facilisis in</li>
		<li>Morbi leo risus</li>
		<li>Cras justo odio
...
<!---Prism Pre code-->
<figure class="highlight clip-widget" id="list12"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="listgroup-example ">
	<ul class="list-group">
		<li>Dapibus ac facilisis in</li>
		<li>Morbi leo risus</li>
		<li>Cras justo odio
