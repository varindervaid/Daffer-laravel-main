...
@section('content')
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Backgrounds</h2>
								<ol class="breadcrumb">
							...
							<div class="col-xl-9 col-lg-12">
								<div class="card custom-card" id="graybg">
									<div class="card-body">
										...
										<div class="gray-set">
											<div class="flex-1 bg-gray-100 ht-100p p-3 tx-white-7">.bg-gray-100</div>
											<div class="flex-1 bg-gray-200 ht-100p p-3 tx-white-7">.bg-gray-200</div>
											<div class="flex-1 bg-gray-300 ht-100p p-3 tx-white-7">.bg-gray-300</div>
											<div class="flex-1 bg-gray-400 ht-100p p-3 tx-white-7">.bg-gray-400</div>
											<div class="flex-1 bg-gray-500 ht-100p p-3 tx-white-7">.bg-gray-500</div>
											<div class="flex-1 bg-gray-600 ht-100p p-3 tx-white-7">.bg-gray-600</div>
									...
									<div class="card-body">
										...
										<div class="d-flex flex-wrap ht-50 mb-lg-5">
											<div class="flex-1 pos-relative">
												<img alt="" class="wd-100p ht-100p object-fit-cover" src="{{asset('assets/img/media/7.jpg')}}">
