									...
									<div class="card-body">
										...
										<div class="">
											...
											<div class="form-group row justify-content-end mb-0">
												<div class="col-md-8 ps-md-2">
													<button class="btn ripple btn-primary pd-x-30 mg-r-5 mb-2">Register</button>
													<button class="btn ripple btn-secondary pd-x-30 mb-2">Cancel</button>
												</div>
											</div>
										</div>
									</div>
						...
						<div class="col-lg-6 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										...
										<div class="">
											<a class="btn ripple btn-main-primary" data-bs-target="#modaldemo1" data-bs-toggle="modal" href="javascript:void(0);">View Live Demo</a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="card custom-card">
									<div class="card-body">
										...
										<div class="main-dropdown-form-demo">
											<button class="btn ripple btn-main-primary pd-x-20" data-bs-toggle="dropdown">Live Example <i class="icon ion-ios-arrow-down mg-l-5 tx-12"></i></button>
...
@section('scripts')
		...
		@vite('public/assets/js/form-layouts.js')
