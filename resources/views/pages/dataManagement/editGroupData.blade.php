...
<div class="page-header">
    <div class="align-items-center d-flex gap-3">
        ...
        <h2 class="main-content-title tx-24 mg-b-5">Edit Grouped Data</h2>
    </div>
</div>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form id="add_data_form" action="{{route('edit.group.data',[request('id'),request('grouped_name')])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div id="dynamic-field-container">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="group_name" value="{{$grouped_name}}" id="data_group_name" placeholder="Enter group name" required>
                                    <input type="hidden" id="old_group_name" value="{{$grouped_name}}" >
                            ...
                            <div class="row dynamic-field-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" value="{{$data['title']}}" name="fields[0][title]" placeholder="Enter title" required>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="value"><b>Field Value</b></label>
                                    <input type="text" class="form-control" value="{{$data['value']}}" name="fields[0][value]" placeholder="Enter value" required>
                                </div>
