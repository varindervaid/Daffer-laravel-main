...
@section('content')
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Accordions</h2>
								<ol class="breadcrumb">
										...
										<div aria-multiselectable="true" class="accordion accordion-color" id="accordion2" role="tablist">
											<div class="card">
												<div class="card-header" id="headingOne2" role="tab">
													<a aria-controls="collapseOne2" aria-expanded="false" data-bs-toggle="collapse" href="#collapseOne2">Making a Beautiful CSS3 Button Set</a>
												</div>
											...
											<div class="card">
												<div class="card-header" id="headingTwo2" role="tab">
													<a aria-controls="collapseTwo2" aria-expanded="true" class="collapsed" data-bs-toggle="collapse" href="#collapseTwo2">Horizontal Navigation Menu Fold Animation</a>
												</div>
												<div aria-labelledby="headingTwo2" class="collapse" data-bs-parent="#accordion2" id="collapseTwo2" role="tabpanel">
													<div class="card-body">
														Anim pariatur cliche reprehEnderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumEnda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore.
													</div>
												</div>
											...
											<div class="card">
												<div class="card-header" id="headingThree2" role="tab">
													<a aria-controls="collapseThree2" aria-expanded="false" class="collapsed" data-bs-toggle="collapse" href="#collapseThree2">Creating CSS3 Button with Rounded Corners</a>
												</div>
