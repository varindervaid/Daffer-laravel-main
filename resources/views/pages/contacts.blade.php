											...
											<div class="card main-content-left main-content-left-contacts">
												<div class="tab-menu-heading">
													<div class="tabs-menu1 ">
														<!-- Tabs -->
														<ul class="nav panel-tabs main-nav-line main-nav-line-chat d-flex ps-3 ">
															<li><a href="#all-contact" class="nav-link active me-3" data-bs-toggle="tab">All Contacts</a></li>
															<li><a href="#fav-contact" class="nav-link" data-bs-toggle="tab">Favorites</a></li>
														</ul>
													</div>
												</div>
													...
													<div class="tab-content">
														<div class="tab-pane active" id="all-contact">
															<div class="main-contacts-list" id="mainContactList">
																...
																<div class="main-contact-item">
																	<div class="main-img-user online"><img alt="avatar" src="{{asset('assets/img/users/7.jpg')}}"></div>
																	<div class="main-contact-body">
																...
																<div class="main-contact-item">
																	<div class="main-img-user online"><img alt="avatar" src="{{asset('assets/img/users/8.jpg')}}"></div>
																	<div class="main-contact-body">
																...
																<div class="main-contact-item">
																	<div class="main-img-user online"><img alt="avatar" src="{{asset('assets/img/users/9.jpg')}}"></div>
																	<div class="main-contact-body">
																...
																<div class="main-contact-item">
																	<div class="main-img-user"><img alt="avatar" src="{{asset('assets/img/users/10.jpg')}}"></div>
																	<div class="main-contact-body">
																...
																<div class="main-contact-item">
																	<div class="main-img-user online"><img alt="avatar" src="{{asset('assets/img/users/11.jpg')}}"></div>
																	<div class="main-contact-body">
														...
														<div class="tab-pane" id="fav-contact">
															<div class="main-contacts-list" id="mainContactList1">
																...
																<div class="main-contact-item">
																	<div class="main-img-user"><img alt="avatar" src="{{asset('assets/img/users/8.jpg')}}"></div>
																	<div class="main-contact-body">
																...
																<div class="main-contact-item">
																	<div class="main-img-user"><img alt="avatar" src="{{asset('assets/img/users/11.jpg')}}"></div>
																	<div class="main-contact-body">
																		<h6>Aileen Mante</h6><span>+1-234-567-890</span>
																	</div>
																	<a class="main-contact-star" href="javascript:void(0);">
																...
																<div class="main-contact-item">
																	<div class="main-img-user"><img alt="avatar" src="{{asset('assets/img/users/12.jpg')}}"></div>
																	<div class="main-contact-body">
											...
											<div class="main-contact-info-header pt-3">
												<div class="media">
													<div class="main-img-user">
														<img alt="avatar" src="{{asset('assets/img/users/1.jpg')}}"> <a href="javascript:void(0);"><i class="fe fe-camera"></i></a>
													</div>
												...
												<div class="main-contact-action btn-list pt-3 pe-3">
													<a href="javascript:void(0);" class="btn ripple btn-primary text-white btn-icon" data-bs-placement="top" data-bs-toggle="tooltip" title="Edit Profile"><i class="fe fe-edit"></i></a>
													<a href="javascript:void(0);" class="btn ripple btn-secondary text-white btn-icon" data-bs-placement="top" data-bs-toggle="tooltip" title="Delete Profile"><i class="fe fe-trash-2"></i></a>
												</div>
											</div>
...
@section('scripts')
		...
		<!-- INTERNAL CONTACT JS -->
		@vite('public/assets/js/contacts.js')
