                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                                <div class="working-svg-container svg-container-3">
                                                    <svg xmlns="http://www.w3.org/2000/svg" id="Layer_2" x="0" y="0"
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="card bg-transparent mb-0">
                                    ...
                                    <span class="landing-title"></span>
                                    <div class="demo-screen-skin code-quality" id="dependencies1">
                                        <div class="text-center p-0">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-lg-12 px-0">
                                                    <div class="feature-logos mt-5">
                                                        <div class="slide">
                                                            <img src="{{asset('assets/landing/web/7.png')}}" alt="img">
                                                            <h5 class="mt-3 text-white">Laravel</h5>
                                                        </div>
                                                        <div class="slide">
                                                            <img src="{{asset('assets/landing/web/1.png')}}" alt="img">
                                                            <h5 class="mt-3 text-white">Bootstrap5</h5>
                                                        </div>
                                                        <div class="slide">
                                                            <img src="{{asset('assets/landing/web/2.png')}}" alt="img">
                                                            <h5 class="mt-3 text-white">HTML5</h5>
                                                        </div>
                                                        <div class="slide">
                                                            <img src="{{asset('assets/landing/web/3.png')}}" alt="img">
                                                            <h5 class="mt-3 text-white">JQuery</h5>
                                                        </div>
                                                        <div class="slide">
                                                            <img src="{{asset('assets/landing/web/4.png')}}" alt="img">
                                                            <h5 class="mt-3 text-white">Sass</h5>
                                                        </div>
                                                        <div class="slide">
                                                            <img src="{{asset('assets/landing/web/5.png')}}">
                                                            <h5 class="mt-3 text-white">Gulp</h5>
                                                        </div>
                                                        <div class="slide">
                                                            <img src="{{asset('assets/landing/web/6.png')}}">
                                ...
                                <div class="pricing-tabs text-center">
                                    <div class="pri-tabs-heading text-center mt-3">
                                        <ul class="nav nav-price">
                                            <li ><a data-bs-toggle="tab" href="#month" class="rounded-start-5">Monthly</a></li>
                                            <li ><a class="rounded-end-5 active show" data-bs-toggle="tab" 
                                ...
                                <section class="sptb demo-screen-demo" id="faqs">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-12 col-lg-6 reveal revealright">
                                            <img src="{{asset('assets/landing/images/frequently-asked-questions.png')}}" alt="">
                                        </div>
                                    </div>
                                </section>
                            </div>
