								...
								<div class="card custom-card">
									<div class="card-body">
										...
										<div class="expansion-value d-flex tx-inverse">
											<strong><i class="fas fa-caret-down me-1 text-danger"></i> 0.5%</strong>
											<strong class="ms-auto"><i class="fas fa-caret-up me-1 text-success"></i>0.7%</strong>
										</div>
										<div class="progress">
							...
							<div class="col-sm-6 col-md-6 col-xl-3">
								<div class="card custom-card">
									<div class="card-body">
										...
										<div class="expansion-value d-flex tx-inverse">
											<strong><i class="fas fa-caret-up me-1 text-success"></i> 0.72%</strong>
											<strong class="ms-auto"><i class="fas fa-caret-down me-1 text-danger"></i>0.43%</strong>
										</div>
										<div class="progress">
							...
							<div class="col-sm-6 col-md-6 col-xl-3">
								<div class="card custom-card">
									<div class="card-body">
										...
										<div class="expansion-value d-flex tx-inverse">
											<strong><i class="fas fa-caret-down me-1 text-danger"></i> 1.4%</strong>
											<strong class="ms-auto"><i class="fas fa-caret-down me-1 text-danger"></i>1.44%</strong>
										</div>
										<div class="progress">
							...
							<div class="col-sm-6 col-md-6 col-xl-3">
								<div class="card custom-card">
									<div class="card-body">
										...
										<div class="expansion-value d-flex tx-inverse">
											<strong><i class="fas fa-caret-down me-1 text-danger"></i> 0.4%</strong>
											<strong class="ms-auto"><i class="fas fa-caret-up me-1 text-success"></i>0.9%</strong>
										</div>
										<div class="progress">
								...
								<div class="card custom-card">
									<div class="card-body">
										<div class="card-order ">
											...
											<i class="mdi mdi-account-multiple icon-size float-start text-primary"></i><span class="font-weight-bold">3,672</span></h2>
								...
								<div class="card custom-card">
									<div class="card-body">
										<div class="card-widget">
											...
											<h2 class="text-end"><i class="mdi mdi-cube icon-size float-start text-primary"></i><span class="font-weight-bold">$89,265</span></h2>
								...
								<div class="card custom-card">
									<div class="card-body">
										<div class="card-widget">
											...
											<h2 class="text-end"><i class="icon-size mdi mdi-poll-box   float-start text-primary"></i><span class="font-weight-bold">$23,987</span></h2>
								...
								<div class="card custom-card">
									<div class="card-body">
										<div class="card-widget">
											...
											<h2 class="text-end"><i class="mdi mdi-cart icon-size float-start text-primary"></i><span class="font-weight-bold">46,486</span></h2>
										...
										<div class="card-block">
											<div class="row align-items-center justify-content-center">
												<div class="col-auto user-lock">
													<img class="img-fluid rounded-circle" src="{{asset('assets/img/users/8.jpg')}}" alt="avatar">
												</div>
												<div class="col">
													<h5>Joyce Chua</h5>
											...
											<ul class="task-list">
												<li>
													...
													<p class="text-muted fs-12">Adam Berry finished task on<a href="javascript:void(0);" class="font-weight-semibold"> Project Management</a></p>
												</li>
												<li>
													<i class="task-icon bg-secondary"></i>
													<h6>New Comment<span class="float-end text-muted fs-11">25 Oct 2020</span></h6>
													<p class="text-muted fs-12">Victoria commented on Project <a href="javascript:void(0);" class="font-weight-semibold"> AngularJS Template</a></p>
												</li>
												<li>
													<i class="task-icon bg-secondary"></i>
													<h6>New Comment<span class="float-end text-muted fs-11">25 Oct 2020</span></h6>
												...
												<li>
													...
													<p class="text-muted mb-0 fs-12">Petey Cruiser finished task <a href="javascript:void(0);" class="font-weight-semibold"> Integrated management</a></p>
												</li>
											</ul>
										</div>
									</div>
								...
								<div class="card custom-card">
									...
									<div class="card-body pt-2 mt-0">
										<div class="list-group border projects-list">
											<a href="javascript:void(0);" class="list-group-item list-group-item-action flex-column border-end-0 border-start-0 align-items-start p-3 border-top-0">
											...
											<a href="javascript:void(0);" class="list-group-item list-group-item-action flex-column border-end-0 border-start-0 align-items-start p-3">
												<div class="d-flex w-100 justify-content-between">
											...
											<a href="javascript:void(0);" class="list-group-item list-group-item-action border-end-0 border-start-0  flex-column align-items-start p-3">
												<div class="d-flex w-100 justify-content-between">
										...
										<div class="table-responsive">
											<table class="table table-bordered mg-b-0">
												<tbody>
													...
													<tr>
														<td class="bd-l-0">
															<div class="main-img-user"><img alt="avatar" src="{{asset('assets/img/users/3.jpg')}}"></div>
														</td>
														<td class="bd-l-0">
													...
													<tr>
														<td class="bd-l-0">
															<div class="main-img-user"><img alt="avatar" src="{{asset('assets/img/users/4.jpg')}}"></div>
														</td>
														<td class="bd-l-0">
													...
													<tr>
														<td class="bd-l-0">
															<div class="main-img-user"><img alt="avatar" src="{{asset('assets/img/users/5.jpg')}}"></div>
														</td>
														<td class="bd-l-0">
													...
													<tr>
														<td class="bd-l-0">
															<div class="main-img-user"><img alt="avatar" src="{{asset('assets/img/users/6.jpg')}}"></div>
														</td>
														<td class="bd-l-0">
													...
													<tr>
														<td class="bd-l-0">
															<div class="main-img-user"><img alt="avatar" src="{{asset('assets/img/users/7.jpg')}}"></div>
														</td>
														<td class="bd-l-0">
