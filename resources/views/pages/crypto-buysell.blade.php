								...
								<div class="card custom-card overflow-hidden">
									<div class="d-flex mb-3 p-3 border-bottom">
										<div class="align-items-center">
											<h4 class="d-flex">Bitcoin<span class="text-muted tx-13 ms-2 my-auto">BTC</span></h4>
										</div>
										<button class="btn btn-primary ms-auto">Buy Bitcoin</button>
									</div>
									<div class="card-body">
										<div class="d-sm-flex mb-0">
											<div class="">
												<p class="tx-13 text-muted mb-2">Bitcoin [BTC] Price Chart</p>
												<h3>$3468.42<span class="text-success tx-15 ms-2"><i class="fas fas fa-dollar-sign"></i> 23.5</span></h3>
											</div>
											<div class="ms-auto">
												<ul class="nav nav-tabs crypto-btc-usd border-0" id="charts" role="tablist">
													<li class="nav-item border-0">
														<a class="nav-link border-0 active"  data-bs-toggle="tab" href="#chart-tab" role="tab" aria-controls="chart-tab"
														aria-selected="true">1m</a>
													</li>
													<li class="nav-item border-0 ">
														<a class="nav-link border-0 "  data-bs-toggle="tab" href="#chart2-tab" role="tab" aria-controls="chart2-tab"
														aria-selected="false">1h</a>
													</li>
													<li class="nav-item border-0">
														<a class="nav-link border-0 " data-bs-toggle="tab" href="#chart3-tab" role="tab" aria-controls="chart3-tab"
									...
									<div class="card-body">
										...
										<div class="d-flex mt-3 mb-3">
											<div class="">
												...
												<h3>5.47<span class="text-success tx-15 ms-2">CNY</span></h3>
											</div>
										...
										<div class="form-group">
											<div class="input-group">
												<input type="text" class="form-control input-lg wd-80p border-end-0" value="Spend 32 - 6500">
												<div class="wd-30p input-group-btn ">
										...
										<div class="form-group">
											<div class="input-group">
												<input type="text" class="form-control input-lg wd-80p border-end-0" value="Buy">
										...
										<form class="payment-form form">
											<div class="payment-type d-flex">
												<input type="radio" name="radio3" id="credit" value="credit" checked><label class="credit-label payment-cards four ms-0 col" for="credit"><span class="d-none d-md-block">New card</span><img src="{{asset('assets/img/visa.png')}}" alt="visa"></label>
												<input type="radio" name="radio3" id="debit" value="debit"><label class="debit-label payment-cards four col" for="debit"><span class="d-none d-md-block">Debit Card</span><img src="{{asset('assets/img/mastercard.png')}}" alt="Debitcard"></label>
												<input type="radio" name="radio3" id="paypal" value="paypal"><label class="paypal-label payment-cards four col" for="paypal"><span class="d-none d-md-block">Paypal</span><img src="{{asset('assets/img/paypal.png')}}" alt="paypal"></label>
												<input type="radio" name="radio3" id="amex" value="amex"><label class="amex-label payment-cards four col" for="amex"><span class="d-none d-md-block">Amex</span><img src="{{asset('assets/img/amex.png')}}" alt="amexg1096"></label>
											</div>
											<a href="javascript:void(0);" class="btn btn-primary btn-lg btn-block mt-4">Buy Now</a>
										</form>
									</div>
								</div>
							</div>
									...
									<div class="card-body">
										...
										<div class="form-group">
											...
											<div class="p-3 border d-flex">
												<div class="d-flex"><span class="crypto-icon bg-primary-transparent me-3"><i class="cf cf-btc text-primary"></i></span><span class="my-auto tx-18 font-weight-semibold">Bitcoin BTC</span></div>
										...
										<div class="row">
											<div class="form-group col-xl-5 col-lg-12 col-md-12 mb-0">
												<div class="input-group">
													<input type="text" class="form-control border-end-0 input-lg wd-80p" value="0.041323">
											...
											<div class="form-group col-xl-5 col-lg-12 col-md-12 mb-0">
												<div class="input-group">
													<input type="text" class="form-control input-lg wd-80p border-end-0" value="500">
													<div class=" input-group-btn  wd-40p">
														<select class="form-control border-start-0 icons_select2 br-0" data-placeholder="Choose one">
															<optgroup label="Coins">
																<option value="cf cf-btc" data-icon="cf cf-btc cryptoicon bg-primary-transparent text-primary">BTC</option>
										...
										<a href="javascript:void(0);" class="btn btn-primary btn-lg btn-block mt-4">Sell Bitcoin</a>
									</div>
								</div>
							</div>
						</div>
											...
											<table class="table card-table text-nowrap table-bordered border-top">
												...
												<tbody>
													<tr>
														...
														<td>$ 5273.15</td>
														<td>0.1</td>
														<td><span class="badge bg-success-light bg-pill">Completed</span></td>
													...
													<tr>
														...
														<td>$ 2637.37</td>
														<td>0.1</td>
														<td><span class="badge bg-warning-light bg-pill">Pending</span></td>
													...
													<tr>
														...
														<td>$ 6345.16</td>
														<td>0.1</td>
														<td><span class="badge bg-danger-light bg-pill">Cancelled</span></td>
													...
													<tr>
														...
														<td>$ 4853.15</td>
														<td>0.1</td>
														<td><span class="badge bg-info-light bg-pill">In Process</span></td>
...
@section('scripts')
		...
		@vite('public/assets/js/crypto-buysell.js')
