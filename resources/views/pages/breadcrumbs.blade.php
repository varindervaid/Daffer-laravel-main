...
@section('content')
	...
	<!-- Prism Precode -->
	<figure class="highlight clip-widget" id="breadcrumb1"><pre><code class="language-markup"><script type="htms-Spruha/script"><nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			<li class="breadcrumb-item">
				<a href="javascript:void(0);">Home</a>
			</li>
	...
	<!-- Prism Precode -->
	<figure class="highlight clip-widget" id="breadcrumb2"><pre><code class="language-markup"><script type="htms-Spruha/script"><nav aria-label="breadcrumb">
	...
	<!-- Prism Precode -->
	<figure class="highlight clip-widget" id="breadcrumb3"><pre><code class="language-markup"><script type="htms-Spruha/script"><nav aria-label="breadcrumb">
	...
	<!-- Prism Precode -->
	<figure class="highlight clip-widget" id="breadcrumb4"><pre><code class="language-markup"><script type="htms-Spruha/script"><nav class="breadcrumb-3">
		<ol class="breadcrumb breadcrumb-style1">
			<li class="breadcrumb-item">
				<a href="javascript:void(0);">Home</a>
			</li>
	...
	<!-- Prism Precode -->
	<figure class="highlight clip-widget" id="breadcrumb5"><pre><code class="language-markup"><script type="htms-Spruha/script"><nav class="breadcrumb-4">
		<ol class="breadcrumb breadcrumb-style1">
			<li class="breadcrumb-item">
				<a href="javascript:void(0);">Home</a>
			</li>
											...
											<div class="example">
												<nav class="breadcrumb-5">
													<div class="breadcrumb flat">
														<a href="javascript:void(0);" class="active"><span class="badge bg-light me-3">1</span><span class="breadcrumbitem">Browse</span></a>
														<a href="javascript:void(0);"><span class="badge bg-light me-3">2</span><span class="breadcrumbitem">Compare</span></a>
														<a href="javascript:void(0);"><span class="badge bg-light me-3">3</span><span class="breadcrumbitem">Order</span></a>
														<a href="javascript:void(0);"><span class="badge bg-light me-3">4</span><span class="breadcrumbitem">Checkout</span></a>
													</div>
												</nav>
											</div>
	<!-- Prism Precode -->
	<figure class="highlight clip-widget" id="breadcrumb6"><pre><code class="language-markup"><script type="htms-Spruha/script"><nav class="breadcrumb-5">
		<div class="breadcrumb flat">
			<a href="javascript:void(0);" class="active">Browse</a>
