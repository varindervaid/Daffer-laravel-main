...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="typoraph1"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="row row-xs">
	<div class="col-sm-6 col-md-6">
		<h1>h1 Heading</h1>
		<h2>h2 Heading</h2>
		<h3>h3 Heading</h3>
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="typoraph2"><pre><code class="language-markup"><script type="htms-Spruha/script"><h1 class="display-1">Display 1</h1>
<h1 class="display-2">Display 2</h1>
<h1 class="display-3">Display 3</h1>
...
<!-- End Prism Precode -->
	...
	<!-- Prism Precode -->
	<figure class="highlight clip-widget" id="typoraph3"><pre><code class="language-markup"><script type="htms-Spruha/script"><p class="lead mb-0">
	 Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.
	</p></script></code></pre>
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="typoraph4"><pre><code class="language-markup"><script type="htms-Spruha/script"><p>You can use the mark tag to <mark>highlight</mark> text.</p>
<p><del>This line of text is meant to be treated as deleted text.</del></p>
<p><s>This line of text is meant to be treated as no longer accurate.</s></p>
<p><ins>This line of text is meant to be treated as an addition to the document.</ins></p>
<p><u>This line of text will render as underlined</u></p>
...
<!-- End Prism Precode -->
	...
	<!-- Prism Precode -->
	<figure class="highlight clip-widget" id="typoraph5"><pre><code class="language-markup"><script type="htms-Spruha/script"><blockquote class="blockquote mb-0">
	  <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="typoraph6"><pre><code class="language-markup"><script type="htms-Spruha/script"><blockquote class="blockquote text-center">
  <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
  <footer class="blockquote-footer">Someone famous in <cite title="Source Title">Source Title</cite></footer>
</blockquote>
</script></code></pre>
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="typoraph7"><pre><code class="language-markup"><script type="htms-Spruha/script"><blockquote class="blockquote text-end mb-0">
  <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
  <footer class="blockquote-footer">Someone famous in <cite title="Source Title">Source Title</cite></footer>
</blockquote></script></code></pre>
