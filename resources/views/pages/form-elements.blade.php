												...
												<div class="form-group ">
													...
													<div class="selectgroup selectgroup-pills">
														...
														<label class="selectgroup-item">
															...
															<span class="selectgroup-button br-0">CSS</span>
														</label>
														<label class="selectgroup-item">
															<input type="checkbox" name="value" value="PHP" class="selectgroup-input">
															<span class="selectgroup-button br-0">PHP</span>
														</label>
														<label class="selectgroup-item">
															<input type="checkbox" name="value" value="JavaScript" class="selectgroup-input">
															<span class="selectgroup-button br-0">JavaScript</span>
														</label>
														<label class="selectgroup-item">
															<input type="checkbox" name="value" value="Angular" class="selectgroup-input">
															<span class="selectgroup-button br-0">Angular</span>
														</label>
														<label class="selectgroup-item">
															<input type="checkbox" name="value" value="Java" class="selectgroup-input">
															<span class="selectgroup-button br-0">Java</span>
														</label>
														<label class="selectgroup-item">
										...
										<div class="row row-sm">
											<div class="col-lg-4">
												<div class="input-group mb-3">
													<span class="input-group-text border-end-0" id="basic-addon1">@</span>
													<input aria-describedby="basic-addon1" aria-label="Username" class="form-control" placeholder="Username" type="text">
												</div>
											</div>
											<div class="col-lg-4">
												<div class="input-group mb-3">
													<input aria-describedby="basic-addon2" aria-label="Recipient's username" class="form-control border-end-0" placeholder="Recipient's username" type="text">
							...
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										...
										<div class="row row-sm">
											<div class="col-md-6">
												<p class="mg-b-10 mt-2">Show pallete only. If you'd like, spectrum can show the palettes you specify.</p>
												<div>
														...
														<div class="card-body">
															<div class="d-flex justify-content-between">
																<div>
																	...
																	<div class="pickr-container text-center mt-2"></div>
																</div>
																<div>
																	<div class="theme-container1 mx-1"></div>
																	<div class="pickr-container1  text-center mt-2"></div>
																</div>
																<div>
																	<div class="theme-container2"></div>
																	<div class="pickr-container2 text-center mt-2"></div>
																</div>
															</div>
														</div>
													</div>
...
@section('scripts')
		...
		@vite('public/assets/js/form-elements.js')
		...
		@vite('public/assets/js/picker.js')
