...
@section('content')
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Bootstrap Icons</h2>
								<ol class="breadcrumb">
									...
									<div class="card-body">
										<div class="row row-sm">
											<div class="col-lg-12 col-sm-12 mb-2">
												<h3 class="main-content-label">Bootstrap SVG Icons</h3>
												<p class="mb-2">Simply beautiful open source icons. For more info <a href="https://icons.getbootstrap.com/" target="_blank">click here</a>.</p>
											</div>
