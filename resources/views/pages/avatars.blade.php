...
@section('content')
						...
						<div class="page-header">
							<div>
								...
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="javascript:void(0);">Elementss</a></li>
										...
										<div class="text-wrap">
											<div class="example">
												<div class="demo-avatar-group">
													...
													<div class="main-img-user avatar-lg d-none d-sm-block">
	...
	<!-- Prism Precode -->
	<figure class="highlight clip-widget" id="avatar1"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="demo-avatar-group">
		<div class="main-img-user avatar-xs">
			<img alt="avatar" class="rounded-circle" src="{{asset('assets/img/users/2.jpg')}}">
		</div>
		<div class="main-img-user avatar-sm">
										...
										<div class="text-wrap">
											<div class="example">
												<div class="demo-avatar-group">
													...
													<div class="main-img-user avatar-md">
														<img alt="avatar" class="square" src="{{asset('assets/img/users/5.jpg')}}">
													</div>
													<div class="main-img-user avatar-md">
														<img alt="avatar" class="radius" src="{{asset('assets/img/users/6.jpg')}}">
													</div>
												</div>
											</div>
	<!-- Prism Precode -->
	<figure class="highlight clip-widget" id="avatar2"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="demo-avatar-group">
		<div class="main-img-user avatar-md">
			<img alt="avatar" class="rounded-circle" src="{{asset('assets/img/users/4.jpg')}}">
		</div>
		<div class="main-img-user avatar-md">
										...
										<div class="text-wrap">
											<div class="example">
												<div class="demo-avatar-group avatar-list">
													...
													<div class="avatar avatar-lg d-none d-sm-flex bg-warning">
														E
													</div>
	...
	<!-- Prism Precode -->
	<figure class="highlight clip-widget" id="avatar3"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="demo-avatar-group avatar-list">
											...
											<div class="example">
												<div class="demo-avatar-group">
													<div class="main-avatar avatar online">
														<img alt="avatar" class="rounded-circle avatar" src="{{asset('assets/img/users/9.jpg')}}">
													</div>
	...
	<!-- Prism Precode -->
	<figure class="highlight clip-widget" id="avatar4"><pre><code class="language-markup"><script type="htms-Spruha/script"><div class="demo-avatar-group">
		<div class="main-avatar avatar online">
			<img alt="avatar" class="rounded-circle avatar" src="{{asset('assets/img/users/9.jpg')}}">
		</div>
		<div class="main-avatar avatar-md offline">
